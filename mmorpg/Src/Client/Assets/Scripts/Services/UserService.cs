...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable
    {
        ...
        void OnGameLeave(object sender, UserGameLeaveResponse response)
        {
            ...
            Debug.LogFormat("OnGameLeave:{0},msg:{1}",response.Result,response.Errormsg);
            if (this.isQuitGame) {
#if UNITY_EDITOR
        ...
        private void OnGameEnter(object sender, UserGameEnterResponse response)
        {
            ...
            {
                //SceneManager.Instance.LoadScene(DataManager.Instance.Maps[response.].Resource);
        ...
        {
            Debug.LogFormat("result:{0},msg:{1}",response.Result,response.Errormsg);
        ...
        {
            Debug.LogFormat("UserCreateCharacterRequest:name:{0},class:{1}", charName, charClass);
            NetMessage message = new NetMessage();
            message.Request = new NetMessageRequest();
